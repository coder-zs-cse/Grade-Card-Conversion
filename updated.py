...
header = ['ORG_NAME','ORG_NAME_L','ACADEMIC_COURSE_ID','COURSE_NAME','COURSE_NAME_L','STREAM','STREAM_L','SESSION','REGN_NO','RROLL NO','CNAME','GENDER','DOB','FNAME','MNAME','PHOTO','MRKS_REC_STATUS','RESULT', 'DIVISION','GRADE','PERCENT','DOI','SEM','EXAM_TYPE', 'TOT', 'TOT_MKS', 'TOT_CREDIT', 'TOT_CREDIT_POINTS', 'TOT_GRADE_POINTS','GRAND_TOT_MAX','GRAND_TOT_MRKS','GRAND_TOT_CREDIT_POINTS','CGPA','REMARKS','SGPA','ABC_ACCOUNT_ID','TERM_TYPE','TOT_GRADE']
for i in range(1, 11):
...
#SUB1NM	SUB1	SUBd1_TH_MAX	SUB1_PR_MAX	SUB1_CE_MAX	SUB1_TH_MRKS	SUB1_PR_MRKS	SUB1_CE_MRKS	SUB1_TOT	SUB1_GRADE	SUB1_GRADE_POINTS	SUB1_CREDIT	SUB1_CREDIT_POINTS	SUB1_REMARKS	SUB1_CREDIT_ELIGIBILITY
